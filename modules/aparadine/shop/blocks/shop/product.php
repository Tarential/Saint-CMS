<?php if ($block->getId()): $sale = $block->getDiscountPrice() < $block->getPrice() ? 1 : 0; ?>
<div class="saint-product<?php if ($sale) echo " sale"; ?> ssm-sku-<?php echo $block->getSku(); ?>">
	<h2>
		...
		<?php if ($sale): ?>on sale for <span class="saleprice">$<?php echo $block->getDiscountPrice(); ?></span><?php endif; ?>
	</h2>
