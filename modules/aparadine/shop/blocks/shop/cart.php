...
<div id="saint-paypal-buynow"<?php if (isset($args['buynow']) && $args['buynow'] == 1): ?> class="buynow"<?php endif; ?>>
	...
	<input type="hidden" name="return" value="<?php echo $page->getUrl() . "?view=thanks"; ?>" />
	<input type="hidden" name="cancel_return" value="<?php echo $page->getUrl() . "?view=cart"; ?>" />
	<input type="hidden" name="notify_url" value="<?php echo $page->getUrl() . "?view=ipn"; ?>" />
...
<?php else: ?>
<span class="saint-cart-total">You have no items in your cart. <a href="<?php echo $page->getUrl(); ?>">Continue Shopping.</a></span>
<?php endif; ?>
...
<li<?php if ($sale) echo ' class="sale"'; ?>>
	...
	<span class="product-meta">
		...
		<span class="remove-from-cart">
			<a href="<?php echo $page->getUrl(); ?>/?remfromcart=<?php echo $product[0]->getId(); ?>&num=1" class="link">(X)</a>
		</span>
	</span>
</li>
<?php endforeach; ?>
