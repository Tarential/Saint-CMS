...
<form id="saint-search" method="post" action="/search">
	...
	<input name="saint-search-phrase" type="text" value="<?php echo $value; ?>" class="search-phrase" />
	<input name="saint-search-submit" type="submit" value="Go" class="search-submit" />
</form> 
