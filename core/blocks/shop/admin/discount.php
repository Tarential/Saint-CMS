<div class="ssm-discount block-item">
	<div class="edit-button inline" id="<?php echo $id; ?>">
		...
		<span class="amount">
			<?php if (Saint::getBlockSetting($block, $id, "Type") == "flat"): ?>$<?php endif; ?><?php echo Saint::getBlockSetting($block, $id, "Amount"); ?><?php if (Saint::getBlockSetting($block, $id, "Type") == "percent"): ?>%<?php endif; ?> off!
		</span>
